...
import { ArrowRight, Calendar, MapPin, ClipboardList } from 'lucide-react';
    ...
    <div className="mx-auto w-full max-w-3xl overflow-hidden rounded-xl border border-[#15b7b9]/20 bg-gradient-to-br from-[#15b7b9]/5 to-white p-4 shadow-lg">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-base font-semibold text-[#15b7b9]">{t('new-booking')}</h4>
        </div>
        <span
        ...
        <div className="rounded-lg bg-white/50 p-3 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              <h3 className="text-base font-semibold text-gray-900">{metadata.eventName}</h3>
