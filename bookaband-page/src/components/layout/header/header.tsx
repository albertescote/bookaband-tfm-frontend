...
export default function Header({ language }: { language: string }) {
  ...
  const { user, unreadMessages, setUnreadMessages, logoutUser } = useAuth();
  ...
  return (
    <header className="sticky top-0 z-30 h-20 bg-[#f3f4f6] px-4 py-2 transition-all duration-300 ease-in-out sm:px-6">
